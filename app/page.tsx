      ...
      <section className="relative min-h-[90vh] flex flex-col justify-center pt-24 pb-16 overflow-hidden dot-grid-bg">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-6 max-w-7xl mx-auto w-full">
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-display font-black tracking-tighter mb-8 leading-none">
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-white via-white/90 to-white/60 drop-shadow-2xl pb-2">
                Your
              </span>
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 pb-4 h-[1.2em]">
                <CycleText words={['Tasks.', 'Habits.', 'Goals.', 'Life.']} />
              </span>
            </h1>

            <div className="h-24 lg:h-20 flex items-center justify-center lg:justify-start mb-10 w-full">
              <TypewriterText 
                ...
                delay={0.5}
                className="text-base md:text-xl text-white/50 max-w-2xl font-light leading-relaxed"
              />
            </div>

            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start mt-6 w-full">
              ...
              <Link href="/login" className="px-8 py-4 rounded-xl bg-white/5 text-white font-semibold border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all flex items-center justify-center gap-2">
                Watch Demo →
              </Link>
            </div>
