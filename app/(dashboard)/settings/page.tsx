...
import { User, Sliders, Shield, Database, Save, RotateCcw, AlertTriangle } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const { userName: storeName, userEmail: storeEmail, userHandle: storeHandle, updateProfile } = useAppStore();
  ...
  }, [storeName, storeEmail, storeHandle]);
